...
To contribute, it's simple, check the [existing issues](https://github.com/thib1984/pyreversi/issues). If you see an issue you are interested to work, please let a message and i assign you the task. With this, all people know you are working on this issue.
...
git clone https://github.com/thib1984/pyreversi.git
...
python3 -m venv pyreversi_env
source pyreversi_env/bin/activate
